...
class KHM_Attribution_Async_Manager {
    ...
    private function process_attribution_tracking($payload) {
        ...
        $attribution_manager = \KH\Attribution\Providers\Bootstrap::get_manager();
        
        if (!$attribution_manager) {
            return false;
        }

        // Process the attribution data using the modern handler
        return $attribution_manager->handle_click_tracking($payload['click_data']);
    }
    ...
    private function process_conversion($payload) {
        ...
        // Process the conversion using the modern handler
        return $attribution_manager->handle_conversion_tracking($payload['conversion_data']);
    }
