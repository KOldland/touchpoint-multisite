...
class ScheduleRepository {
    ...
    private function map_wp_post( $post ): array {
        ...
        return array(
            ...
            'variant_preview'         => (string) get_post_meta( $post->ID, '_kh_smma_variant_preview', true ),
            'sponsor_id'              => $sponsor_id,
            ...
            'compliance_reason'       => (string) get_post_meta( $post->ID, '_kh_smma_compliance_reason', true ),
