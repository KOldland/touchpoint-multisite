...
use KHM\Connect\ConnectRFPReportingPage;
use KHM\Cron\ConnectRFPUpsellWorker;
use KHM\Cron\ConnectRFPCommissionWorker;
...
use KHM\Connect\ConnectRfpEndpoint;
...
class Plugin {
    ...
    public static function initialize_connect(): void {
        ...
        ( new ConnectRFPReportingPage() )->register();
        ( new ConnectRFPUpsellWorker() )->register();
        ( new ConnectRFPCommissionWorker() )->register();
        ...
        ( new ConnectRfpEndpoint() )->register();
